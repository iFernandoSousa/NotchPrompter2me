...
/** Y offset for prompter window: -1 = 1px above the menu bar edge. */
export const NOTCH_SAFE_Y = -1;
...
export const VOSK_LANGUAGES: readonly VoskLanguageOption[] = [
    ...
    },
    {
        ...
        model: "vosk-model-small-en-in-0.4",
        size: "36M",
    ...
    },
    {
        code: "kz",
        label: "Kazakh",
        model: "vosk-model-small-kz-0.42",
        size: "58M",
    ...
    },
    {
        code: "eo",
        label: "Esperanto",
        model: "vosk-model-small-eo-0.42",
        size: "42M",
    ...
    },
    {
        code: "cs",
        label: "Czech",
        model: "vosk-model-small-cs-0.4-rhasspy",
        size: "44M",
    ...
    },
    {
        code: "tg",
        label: "Tajik",
        model: "vosk-model-small-tg-0.22",
        size: "50M",
    ...
    },
    {
        code: "te",
        label: "Telugu",
        model: "vosk-model-small-te-0.42",
        size: "58M",
    ...
    },
    {
        code: "ky",
        label: "Kyrgyz",
        model: "vosk-model-small-ky-0.42",
        size: "49M",
